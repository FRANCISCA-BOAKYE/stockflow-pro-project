...
const RECENT_RECEIVED = [
  { id: '1', product: 'Coca-Cola 500ml (Case of 24)', supplier: 'BevCo Ltd', qty: 500, date: 'Jun 26, 2026', cost: 12500 },
  { id: '2', product: 'Flour 50kg Bag', supplier: 'Mill Corp', qty: 200, date: 'Jun 24, 2026', cost: 8000 },
  { id: '3', product: 'Cooking Oil 20L Drum', supplier: 'OilTrade', qty: 100, date: 'Jun 22, 2026', cost: 5800 },
  { id: '4', product: 'Rice 50kg Bag', supplier: 'GrainCo', qty: 150, date: 'Jun 20, 2026', cost: 7500 },
];
...
export default function ReceiveStockScreen() {
  ...
  const handleSubmit = () => {
    ...
    Alert.alert('Stock Received', `${qty} units of ${product} from ${supplier} recorded successfully.`, [
  ...
  return (
    <SafeAreaView style={s.page}>
      ...
      {showForm && (
        <View style={s.form}>
          <Text style={s.formTitle}>New Stock Receipt</Text>
          <View style={s.field}>
            <Text style={s.label}>Product name</Text>
            <TextInput style={s.input} placeholder="e.g. Coca-Cola 500ml (Case of 24)" placeholderTextColor="#9CA3AF" value={product} onChangeText={setProduct} />
          </View>
          <View style={s.field}>
            <Text style={s.label}>Supplier / Manufacturer</Text>
            <TextInput style={s.input} placeholder="e.g. BevCo Ltd" placeholderTextColor="#9CA3AF" value={supplier} onChangeText={setSupplier} />
          </View>
          <View style={s.row}>
          ...
          <TouchableOpacity style={s.submitBtn} onPress={handleSubmit}>
            ...
            <Text style={s.submitBtnText}>Record Receipt</Text>
          </TouchableOpacity>
        </View>
      )}

      <View style={s.body}>
        <Text style={s.sectionLabel}>Recent receipts</Text>
        <FlatList
          data={RECENT_RECEIVED}
