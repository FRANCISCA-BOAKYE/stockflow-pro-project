...
const MENU_ITEMS = [
  ...
  { label: 'Sub-accounts', icon: 'people-outline', color: '#059669', bg: '#ECFDF5' },
  { label: 'Subscription', icon: 'card-outline', color: '#C27803', bg: '#FFFBEB' },
  { label: 'Invoices', icon: 'receipt-outline', color: '#6B7280', bg: '#F3F4F6' },
];
...
const s = StyleSheet.create({
  ...
  avatarText: { color: '#fff', fontSize: 18, fontWeight: '700', letterSpacing: 0.5 },
