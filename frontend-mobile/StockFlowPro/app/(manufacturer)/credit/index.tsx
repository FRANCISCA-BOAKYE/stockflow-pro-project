      ...
      <View style={s.body}>
        <View style={s.balanceCard}>
          <View style={s.balRow}>
            ...
            <View style={s.balIcon}><Ionicons name='wallet-outline' size={28} color='rgba(255,255,255,0.6)' /></View>
          </View>
        </View>
        <FlatList data={data} keyExtractor={item => item.id} contentContainerStyle={{ gap: 8, paddingBottom: 100 }}
          renderItem={({ item }) => {
