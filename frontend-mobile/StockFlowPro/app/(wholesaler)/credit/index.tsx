...
const THEY_OWE = [
  { id:'1', name:'Kofi Mensah', due:'Jun 30, 2026', amount:85, status:'DUE_SOON' as const },
  { id:'2', name:'Ama Serwaa', due:'Jun 15, 2026', amount:210, status:'OVERDUE' as const },
  { id:'3', name:'Kweku Asante', due:'Jul 10, 2026', amount:45, status:'OUTSTANDING' as const },
];
const I_OWE = [
  { id:'4', name:'Apex Distributors', due:'Jul 5, 2026', amount:3200, status:'OUTSTANDING' as const },
];
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.sub}>Retailer credit account</Text>
      </View>
      ...
      <View style={styles.body}>
        ...
        <FlatList data={data} keyExtractor={i=>i.id} contentContainerStyle={{gap:8}}
          renderItem={({item})=>{
            const s = STATUS[item.status as StatusKey];
            return (
