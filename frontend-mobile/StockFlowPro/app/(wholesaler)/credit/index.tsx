...
const THEY_OWE_ME = [
  { id: '1', name: 'Bright Mart Retail', due: 'Jun 30, 2026', amount: 4200.00, status: 'DUE_SOON' },
  { id: '2', name: 'Sunrise Shop', due: 'Jun 15, 2026', amount: 6800.00, status: 'OVERDUE' },
  { id: '3', name: 'Delta Stores', due: 'Jul 10, 2026', amount: 1480.00, status: 'OUTSTANDING' },
  { id: '4', name: 'City Mart', due: 'Jun 1, 2026', amount: 2200.00, status: 'SETTLED' },
];

const I_OWE_THEM = [
  { id: '5', name: 'Acme Manufacturing', due: 'Jul 5, 2026', amount: 18000.00, status: 'OUTSTANDING' },
  { id: '6', name: 'BevCo Ltd', due: 'Jun 25, 2026', amount: 9500.00, status: 'DUE_SOON' },
];
...
export default function WholesalerCreditScreen() {
  ...
  return (
    <SafeAreaView style={s.page}>
      <View style={s.header}>
        ...
        <Text style={s.sub}>Retailer credit accounts</Text>
      </View>
      <View style={s.tabs}>
        ...
        <View style={s.balanceCard}>
          <View style={s.balRow}>
            <View>
              ...
              <Text style={s.balAmount}>${total.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</Text>
