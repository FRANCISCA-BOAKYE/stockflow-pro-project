...
export default function WholesalerMoreScreen() {
  ...
  const MENU_ITEMS = [
    ...
    { label: 'Team Activity', icon: 'shield-checkmark-outline', color: colors.purpleDark, bg: colors.purpleSurface, route: '/(wholesaler)/activity', ownerOnly: true },
    { label: 'Receive Stock', icon: 'arrow-down-circle-outline', color: colors.success, bg: colors.successSurface, route: '/receive-stock' },
    ...
    { label: 'Linked Partners', icon: 'link-outline', color: colors.primary, bg: colors.primarySurface, route: '/(wholesaler)/linked-partners' },
