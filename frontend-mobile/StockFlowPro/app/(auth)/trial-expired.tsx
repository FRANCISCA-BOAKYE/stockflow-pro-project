    ...
    <SafeAreaView style={s.page}>
      <ScrollView contentContainerStyle={s.body} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={s.subscribeBtn} onPress={handleSubscribe}>
          <Ionicons name="card-outline" size={18} color={colors.onPrimary} style={{ marginRight: 8 }} />
...
const makeStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  iconBox: { width: 70, height: 70, borderRadius: 35, backgroundColor: colors.warningSurface, alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  title: { fontSize: 22, fontWeight: '700', color: colors.textPrimary, textAlign: 'center' },
  subtitle: { fontSize: 13, color: colors.textMuted, textAlign: 'center', marginBottom: 8 },
  safeBox: { flexDirection: 'row', backgroundColor: colors.successSurface, borderRadius: 14, padding: 14, width: '100%', borderWidth: 0.5, borderColor: colors.success + '33' },
  safeTitle: { fontSize: 13, fontWeight: '700', color: colors.successText, marginBottom: 3 },
  safeText: { fontSize: 12, color: colors.successText, lineHeight: 17 },
  sectionLabel: { fontSize: 13, fontWeight: '600', color: colors.textPrimary, alignSelf: 'flex-start', marginTop: 8 },
  planCard: { width: '100%', backgroundColor: colors.surface, borderRadius: 14, padding: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 0.5, borderColor: colors.border },
  ...
  subscribeBtn: { backgroundColor: colors.primary, borderRadius: 12, padding: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', marginTop: 10 },
  subscribeBtnText: { color: colors.onPrimary, fontSize: 15, fontWeight: '600' },
  logoutBtn: { padding: 10 },
  logoutBtnText: { color: colors.textPlaceholder, fontSize: 13 },
});
