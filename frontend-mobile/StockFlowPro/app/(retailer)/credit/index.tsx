...
const THEY_OWE_ME = [
  { id: '1', name: 'John Mensah', due: 'Jun 30, 2026', amount: 120.00, status: 'DUE_SOON' },
  { id: '2', name: 'Abena Asante', due: 'Jun 15, 2026', amount: 85.50, status: 'OVERDUE' },
  { id: '3', name: 'Kofi Boateng', due: 'Jul 10, 2026', amount: 200.00, status: 'OUTSTANDING' },
  { id: '4', name: 'Ama Owusu', due: 'Jun 1, 2026', amount: 45.00, status: 'SETTLED' },
];
            ...
            return (
              <View style={s.card}>
                ...
                <View style={{ alignItems: 'flex-end' }}>
                  <Text style={s.acctAmt}>${item.amount.toFixed(2)}</Text>
